                ...
                <div className="row d-block d-xl-flex align-items-center">
                  <div className="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                    ...
                    <div className="d-sm-none">
                      ...
                      <h3 className="fw-extrabold mb-1">{userCount.length}</h3>
                    </div>
                  </div>
              ...
              <div className="card-body">
                <div className="row d-block d-xl-flex align-items-center">
                  <div className="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                    ...
                    <div className="d-sm-none">
                      <h2 className="fw-extrabold h5">Total Orders</h2>
                      <h3 className="mb-1">{orderCount.length}</h3>
                    </div>
                  </div>
                  <div className="col-12 col-xl-7 px-xl-0">
                    <div className="d-none d-sm-block">
                      <h2 className="h5">Total Orders</h2>
                      <h3 className="fw-extrabold mb-1">{orderCount.length}</h3>
                    </div>
                ...
                <div className="card-body">
                  ...
                  <div className="row align-items-center mb-4">
                    ...
                    <div className="col">
                      <div className="progress-wrapper">
                        <div className="progress-info">
                          <div className="h6 mb-0">YouKart - Design System</div>
                          <div className="small fw-bold text-gray-500">
                            <span>60 %</span>
                          </div>
                        </div>
